...
namespace BaiThi.Net
{
    public partial class frmNhansu : Form
    {
        ...
        private void frmNhansu_Load(object sender, EventArgs e)
        {
            ...
            Con.ConnectionString = @"Data Source=DESKTOP-7V1GAAL;Initial Catalog=QLNS;Integrated Security=True";
            ...
            frmNhansu.FillCombo("SELECT MaBoPhan FROM TblBoPhan", comboBox2, "MaBoPhan", "MaBoPhan");
        ...
        {
            frmNhansu.FillCombo("select p.MaPhong from TblBoPhan b,TblPhongBan p where b.MaBoPhan=p.MaBoPhan and p.MaBoPhan=N'" + comboBox2.SelectedValue + "'", comboBox3, "MaPhong", "MaPhong");
        ...
        {
            string insert = "insert into TblNVThoiViec(HoTen,CMTND,NgayThoiViec,LyDo) select HoTen,CMTND,NgayHetHan,GhiChu from TblTTNVCoBan where MaNV='" + textBox3.Text + "'";
            {
                cls.thucthiketnoi(insert);
                cls.loaddatagridview(dataGridView1, "select * from TblTTNVCoBan");
            }
